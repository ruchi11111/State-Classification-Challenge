...
class StatesDatasetTrain(data.Dataset):
    """
...
def get_loaderTrain(data_dir, batch_size, shuffle, num_workers, drop_last=False, args=None):
    '''
        data loader function
    '''

    dataset = StatesDatasetTrain(data_dir=data_dir, args=args)
...
class StatesDatasetValid(data.Dataset):
    """
        Dataloader to generate dataset
    """

    def __init__(self, data_dir="valid", transforms=None, args=None):
        '''
            function to initialize dataset.
        '''
...
def get_loaderValid(data_dir, batch_size, shuffle, num_workers, drop_last=False, args=None):
    '''
        data loader function
    '''

    datasetValid = StatesDatasetValid(data_dir=data_dir, args=args)

    data_loaderValid = torch.utils.data.DataLoader(dataset=datasetValid,
                                              batch_size=batch_size, shuffle=shuffle, num_workers=num_workers,
                                              drop_last=drop_last, collate_fn=collate_fn, pin_memory=True)
    return data_loaderValid, datasetValid
